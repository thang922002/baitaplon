...
<html>
<head>
<link type="text/css" href="css/itc.css" rel="stylesheet">
<meta charset="utf-8">
<title>ICT 36 - ICT NEWS</title>
</head>
...
<div id="contend">
  <div id="right">
    <img src="ima/vivo2.png" width="300" height="500"> 
  </div>
  <h3 class="divtin"> <a href="dangnhap.php">
      <p>TIN NỔI BẬT</p>
    </a>
  </h3>
  <div class="div121">
    <div class="div1211"> <br>
      <img src="ima/email.gif" class="img2"> <br>
      <a href="http://genk.vn/samsung-galaxy-s10-vs-xiaomi-mi-9-cung-cau-hinh-manh-3-camera-cam-bien-van-tay-duoi-man-hinh-lieu-s10-co-dang-muc-gia-gap-doi-20190301133736815.chn" class="a1"> 
        <h2>Cách hẹn giờ gửi email bằng Gmail</h2>
      </a> <br>
      Gmail từ hôm nay bắt đầu được bổ sung tính năng hẹn giờ gửi email, tiện cho anh em nào muốn soạn thư trước rồi hẹn giờ gửi cho khỏi quên. 
    </div>
    <br>
    <br>
    <div class="div1212">
      <img src="ima/6g.jpg" width="280" height="160">
      <h2>Quên 5G đi, Trung Quốc đang phát triển 6G rồi... nhưng để làm gì?</h2>
      <br>
      Chiếc smartband giá chưa đầy 100.000 đồng nhưng vẫn được quảng cáo là có hàng loạt tính năng còn... <br>
      <br>
      <hr>
      <h3>Xiaomi ra mắt Mi 9 SE phiên bản “gấu nâu” giới hạn kèm bộ phụ kiện cực cute, giá 8.7 triệu đồng</h3>
    </div>
  </div>
  ...
  <div class="divs">
    ...
    <br>
    <span> 
      <img src="ima/anh1.jpg" width="200" height="200"> 
      <a href="#">
    ...
    <br>
    <span> 
      <img src="ima/anh2.jpg" width="200" height="200"> 
      <a href="#">
    ...
    <br>
    <span> 
      <img src="ima/anh3.jpg" width="200" height="200"> 
      <a href="#">
    ...
    <br>
    <span> 
      <img src="ima/anh4.jpg" width="200" height="200"> 
      <a href="#">
